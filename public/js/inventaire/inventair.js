const rechercheproduit = document.getElementById("inventaire_inventaire");

rechercheproduit.addEventListener('input',calculeTotal);

function calculeTotal(){
    let quantite = parseInt(document.getElementById("quantite").value) || 0 ;
    let stock = parseInt(document.getElementById("inventaire_inventaire").value) || 0 ;
    let contoire = parseInt(document.getElementById("stock").value) || 0 ;
    let vendu = parseInt(document.getElementById("vendu").value) || 0 ;
    
    document.getElementById("inventaire_ecart").value = (stock) - (contoire + quantite );    
}

function recherchequantite(){
    
    let data = {};
    const nomproduit  = document.getElementById("inventaire_produit").value ;
    const date = document.getElementById("inventaire_createtAt").value ;
