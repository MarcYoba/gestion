...
use App\Repository\RemboursementARepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: RemboursementARepository::class)]
class RemboursementA
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function getEmprunt(): ?EmpruntA
    {
        return $this->emprunt;
    }

    public function setEmprunt(?EmpruntA $emprunt): static
    {
