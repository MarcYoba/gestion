 ...
 */
final class Version20260321144137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poussin ADD user_id INT DEFAULT NULL, ADD reference VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE poussin ADD CONSTRAINT FK_889C98AFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_889C98AFA76ED395 ON poussin (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_889C98AFA76ED395 ON poussin');
        $this->addSql('ALTER TABLE poussin DROP user_id, DROP reference');
    }
}
