 ...
 */
final class Version20260220093623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_a ADD agence_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE depense_a ADD CONSTRAINT FK_DDDEFBDBD725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_DDDEFBDBD725330D ON depense_a (agence_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_a DROP FOREIGN KEY FK_DDDEFBDBD725330D');
        $this->addSql('DROP INDEX IDX_DDDEFBDBD725330D ON depense_a');
        $this->addSql('ALTER TABLE depense_a DROP agence_id');
    }
}
