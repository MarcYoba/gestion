 ...
 */
final class Version20260406051740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE achat ADD reference VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE fournisseur ADD reference VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE achat DROP reference');
        $this->addSql('ALTER TABLE fournisseur DROP reference');
    }
}
