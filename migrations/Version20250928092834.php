 ...
 */
final class Version20250928092834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lots ADD agance_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE lots ADD CONSTRAINT FK_916087CE236A171E FOREIGN KEY (agance_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_916087CE236A171E ON lots (agance_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_916087CE236A171E ON lots');
        $this->addSql('ALTER TABLE lots DROP agance_id');
    }
}
