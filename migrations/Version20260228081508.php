 ...
 */
final class Version20260228081508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inventaire_caisse_a (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, vente DOUBLE PRECISION NOT NULL, caisse DOUBLE PRECISION NOT NULL, ecart DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, justificatif VARCHAR(255) NOT NULL, INDEX IDX_C5EE91FEA76ED395 (user_id), INDEX IDX_C5EE91FED725330D (agence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE inventaire_caisse_a ADD CONSTRAINT FK_C5EE91FEA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE inventaire_caisse_a ADD CONSTRAINT FK_C5EE91FED725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventaire_caisse_a DROP FOREIGN KEY FK_C5EE91FEA76ED395');
        $this->addSql('ALTER TABLE inventaire_caisse_a DROP FOREIGN KEY FK_C5EE91FED725330D');
        $this->addSql('DROP TABLE inventaire_caisse_a');
    }
}
