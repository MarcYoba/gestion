 ...
 */
final class Version20250808072809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE caisse ADD agence_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE caisse ADD CONSTRAINT FK_B2A353C8D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_B2A353C8D725330D ON caisse (agence_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B2A353C8D725330D ON caisse');
        $this->addSql('ALTER TABLE caisse DROP agence_id');
    }
}
