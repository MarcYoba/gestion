 ...
 */
final class Version20251226125207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brouillon (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, client_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quantite DOUBLE PRECISION DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, montant DOUBLE PRECISION DEFAULT NULL, facture VARCHAR(255) NOT NULL, INDEX IDX_B088DFEBF347EFB (produit_id), INDEX IDX_B088DFEBD725330D (agence_id), INDEX IDX_B088DFEB19EB6921 (client_id), INDEX IDX_B088DFEBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
