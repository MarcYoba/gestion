 ...
 */
final class Version20250902100526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE historique ADD agance_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE historique ADD CONSTRAINT FK_EDBFD5EC236A171E FOREIGN KEY (agance_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_EDBFD5EC236A171E ON historique (agance_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_EDBFD5EC236A171E ON historique');
        $this->addSql('ALTER TABLE historique DROP agance_id');
    }
}
