 ...
 */
final class Version20251015111608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tresorerie_a CHANGE i ordre INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tresorerie_a CHANGE ordre i INT NOT NULL');
    }
}
