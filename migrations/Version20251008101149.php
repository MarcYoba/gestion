 ...
 */
final class Version20251008101149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prospection ADD agence_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prospection ADD CONSTRAINT FK_47EBD1B0D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_47EBD1B0D725330D ON prospection (agence_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_47EBD1B0D725330D ON prospection');
        $this->addSql('ALTER TABLE prospection DROP agence_id');
    }
}
