 ...
 */
final class Version20260314104705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transfert ADD employer_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE transfert ADD CONSTRAINT FK_1E4EACBB41CD9E7A FOREIGN KEY (employer_id) REFERENCES employer (id)');
        $this->addSql('CREATE INDEX IDX_1E4EACBB41CD9E7A ON transfert (employer_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transfert DROP FOREIGN KEY FK_1E4EACBB41CD9E7A');
        $this->addSql('DROP INDEX IDX_1E4EACBB41CD9E7A ON transfert');
        $this->addSql('ALTER TABLE transfert DROP employer_id');
    }
}
