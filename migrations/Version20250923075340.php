 ...
 */
final class Version20250923075340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation ADD examain VARCHAR(255) NOT NULL, ADD docteur VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation DROP examain, DROP docteur');
    }
}
