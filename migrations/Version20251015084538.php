 ...
 */
final class Version20251015084538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tresorerie (id INT AUTO_INCREMENT NOT NULL, libelles VARCHAR(255) NOT NULL, net DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, ordre INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
