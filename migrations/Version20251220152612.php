 ...
 */
final class Version20251220152612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD reference VARCHAR(255) DEFAULT NULL, ADD localisation VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients DROP reference, DROP localisation');
    }
}
