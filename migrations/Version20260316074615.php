 ...
 */
final class Version20260316074615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture_a CHANGE reference reference INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture_a CHANGE reference reference INT NOT NULL');
    }
}
