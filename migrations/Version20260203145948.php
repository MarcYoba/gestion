 ...
 */
final class Version20260203145948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prospection ADD nature VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE prospection_a ADD nature VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prospection DROP nature');
        $this->addSql('ALTER TABLE prospection_a DROP nature');
    }
}
