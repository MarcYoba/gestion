 ...
 */
final class Version20260116093040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE magasin (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quantite DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, INDEX IDX_54AF5F27F347EFB (produit_id), INDEX IDX_54AF5F27D725330D (agence_id), INDEX IDX_54AF5F27A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE magasin ADD CONSTRAINT FK_54AF5F27F347EFB FOREIGN KEY (produit_id) REFERENCES produit_a (id)');
        $this->addSql('ALTER TABLE magasin ADD CONSTRAINT FK_54AF5F27D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE magasin DROP FOREIGN KEY FK_54AF5F27D725330D');
