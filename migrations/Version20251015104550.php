 ...
 */
final class Version20251015104550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tresorerie_a (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, libelles VARCHAR(255) NOT NULL, net DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, i INT NOT NULL, INDEX IDX_A28458B6A76ED395 (user_id), INDEX IDX_A28458B6D725330D (agence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE tresorerie_a ADD CONSTRAINT FK_A28458B6A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE tresorerie_a ADD CONSTRAINT FK_A28458B6D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tresorerie_a DROP FOREIGN KEY FK_A28458B6A76ED395');
        $this->addSql('ALTER TABLE tresorerie_a DROP FOREIGN KEY FK_A28458B6D725330D');
        $this->addSql('DROP TABLE tresorerie_a');
    }
}
