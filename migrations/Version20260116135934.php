 ...
 */
final class Version20260116135934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transfert (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quantite DOUBLE PRECISION NOT NULL, reste DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, INDEX IDX_1E4EACBBF347EFB (produit_id), INDEX IDX_1E4EACBBD725330D (agence_id), INDEX IDX_1E4EACBBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE transfert ADD CONSTRAINT FK_1E4EACBBF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transfert DROP FOREIGN KEY FK_1E4EACBBF347EFB');
