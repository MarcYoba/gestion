 ...
 */
final class Version20250930123237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depense_actif (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, agecne_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, libelle VARCHAR(255) NOT NULL, createt_ad DATE NOT NULL, INDEX IDX_E4DCB7AFA76ED395 (user_id), INDEX IDX_E4DCB7AF932BE462 (agecne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE depense_actif ADD CONSTRAINT FK_E4DCB7AFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE depense_actif ADD CONSTRAINT FK_E4DCB7AF932BE462 FOREIGN KEY (agecne_id) REFERENCES agence (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_actif DROP FOREIGN KEY FK_E4DCB7AF932BE462');
