 ...
 */
final class Version20260117195605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE magasin_a (id INT AUTO_INCREMENT NOT NULL, agence_id INT DEFAULT NULL, user_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, quantite DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, operation JSON DEFAULT NULL, INDEX IDX_675EA805D725330D (agence_id), INDEX IDX_675EA805A76ED395 (user_id), INDEX IDX_675EA805F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transfert_a (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quantite DOUBLE PRECISION NOT NULL, reste DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, statut VARCHAR(255) NOT NULL, matricule VARCHAR(255) NOT NULL, INDEX IDX_9E1E8454F347EFB (produit_id), INDEX IDX_9E1E8454D725330D (agence_id), INDEX IDX_9E1E8454A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE magasin_a ADD CONSTRAINT FK_675EA805D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('ALTER TABLE magasin_a ADD CONSTRAINT FK_675EA805A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE magasin_a ADD CONSTRAINT FK_675EA805F347EFB FOREIGN KEY (produit_id) REFERENCES produit_a (id)');
        $this->addSql('ALTER TABLE transfert_a ADD CONSTRAINT FK_9E1E8454F347EFB FOREIGN KEY (produit_id) REFERENCES produit_a (id)');
        $this->addSql('ALTER TABLE transfert_a ADD CONSTRAINT FK_9E1E8454D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('ALTER TABLE transfert_a ADD CONSTRAINT FK_9E1E8454A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE magasin_a DROP FOREIGN KEY FK_675EA805D725330D');
        $this->addSql('ALTER TABLE magasin_a DROP FOREIGN KEY FK_675EA805A76ED395');
        $this->addSql('ALTER TABLE magasin_a DROP FOREIGN KEY FK_675EA805F347EFB');
        $this->addSql('ALTER TABLE transfert_a DROP FOREIGN KEY FK_9E1E8454F347EFB');
        $this->addSql('ALTER TABLE transfert_a DROP FOREIGN KEY FK_9E1E8454D725330D');
        $this->addSql('ALTER TABLE transfert_a DROP FOREIGN KEY FK_9E1E8454A76ED395');
        $this->addSql('DROP TABLE magasin_a');
        $this->addSql('DROP TABLE transfert_a');
    }
}
