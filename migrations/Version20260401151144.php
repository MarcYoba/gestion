 ...
 */
final class Version20260401151144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balance_a ADD passif_a_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE balance_a ADD CONSTRAINT FK_41786F98202BD41D FOREIGN KEY (passif_a_id) REFERENCES passif_a (id)');
        $this->addSql('CREATE INDEX IDX_41786F98202BD41D ON balance_a (passif_a_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balance_a DROP FOREIGN KEY FK_41786F98202BD41D');
        $this->addSql('DROP INDEX IDX_41786F98202BD41D ON balance_a');
        $this->addSql('ALTER TABLE balance_a DROP passif_a_id');
    }
}
