 ...
 */
final class Version20251226125426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brouillon (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, agence_id INT DEFAULT NULL, client_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quantite DOUBLE PRECISION DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, montant DOUBLE PRECISION DEFAULT NULL, facture VARCHAR(255) NOT NULL, montanttotal DOUBLE PRECISION DEFAULT NULL, quatitetotal DOUBLE PRECISION NOT NULL, INDEX IDX_B088DFEBF347EFB (produit_id), INDEX IDX_B088DFEBD725330D (agence_id), INDEX IDX_B088DFEB19EB6921 (client_id), INDEX IDX_B088DFEBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE brouillon ADD CONSTRAINT FK_B088DFEBF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
        $this->addSql('ALTER TABLE brouillon ADD CONSTRAINT FK_B088DFEBD725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('ALTER TABLE brouillon ADD CONSTRAINT FK_B088DFEB19EB6921 FOREIGN KEY (client_id) REFERENCES clients (id)');
        $this->addSql('ALTER TABLE brouillon ADD CONSTRAINT FK_B088DFEBA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE brouillon DROP FOREIGN KEY FK_B088DFEBF347EFB');
        $this->addSql('ALTER TABLE brouillon DROP FOREIGN KEY FK_B088DFEBD725330D');
        $this->addSql('ALTER TABLE brouillon DROP FOREIGN KEY FK_B088DFEB19EB6921');
        $this->addSql('ALTER TABLE brouillon DROP FOREIGN KEY FK_B088DFEBA76ED395');
