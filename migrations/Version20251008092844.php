 ...
 */
final class Version20251008092844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prospection (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, localisation VARCHAR(255) NOT NULL, speculation VARCHAR(255) NOT NULL, sujet VARCHAR(255) NOT NULL, souche VARCHAR(255) NOT NULL, ravitallement VARCHAR(255) NOT NULL, commentaire VARCHAR(255) NOT NULL, createt_at DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
