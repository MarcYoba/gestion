 ...
 */
final class Version20260401135107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balance_a ADD actif_a_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE balance_a ADD CONSTRAINT FK_41786F98F001141C FOREIGN KEY (actif_a_id) REFERENCES actif_a (id)');
        $this->addSql('CREATE INDEX IDX_41786F98F001141C ON balance_a (actif_a_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balance_a DROP FOREIGN KEY FK_41786F98F001141C');
        $this->addSql('DROP INDEX IDX_41786F98F001141C ON balance_a');
        $this->addSql('ALTER TABLE balance_a DROP actif_a_id');
    }
}
