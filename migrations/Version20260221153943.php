 ...
 */
final class Version20260221153943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventaire_a ADD agence_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE inventaire_a ADD CONSTRAINT FK_235FE207D725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_235FE207D725330D ON inventaire_a (agence_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventaire_a DROP FOREIGN KEY FK_235FE207D725330D');
        $this->addSql('DROP INDEX IDX_235FE207D725330D ON inventaire_a');
        $this->addSql('ALTER TABLE inventaire_a DROP agence_id');
    }
}
