 ...
 */
final class Version20260406104700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente CHANGE reference reference VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente CHANGE reference reference VARCHAR(255) NOT NULL');
    }
}
