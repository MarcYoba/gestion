 ...
 */
final class Version20260109094401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bond_commande ADD limite INT NOT NULL');
        $this->addSql('ALTER TABLE bond_commande_a ADD limite INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bond_commande DROP limite');
        $this->addSql('ALTER TABLE bond_commande_a DROP limite');
    }
}
