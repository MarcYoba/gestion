 ...
 */
final class Version20260218092246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE versement_a ADD agence_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE versement_a ADD CONSTRAINT FK_5F54C5AD725330D FOREIGN KEY (agence_id) REFERENCES agence (id)');
        $this->addSql('CREATE INDEX IDX_5F54C5AD725330D ON versement_a (agence_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE versement_a DROP FOREIGN KEY FK_5F54C5AD725330D');
        $this->addSql('DROP INDEX IDX_5F54C5AD725330D ON versement_a');
        $this->addSql('ALTER TABLE versement_a DROP agence_id');
    }
}
