 ...
 */
final class Version20250902091150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historique (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, quantite DOUBLE PRECISION NOT NULL, created_at DATE NOT NULL, heurecameroun VARCHAR(255) NOT NULL, heureserver VARCHAR(255) DEFAULT NULL, INDEX IDX_EDBFD5ECF347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
