 ...
 */
final class Version20251008104853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prospection ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_47EBD1B0A76ED395 ON prospection');
        $this->addSql('ALTER TABLE prospection DROP user_id');
    }
}
